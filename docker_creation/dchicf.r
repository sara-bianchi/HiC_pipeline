...
#libraries required
library(bigstatsr, lib.loc = "/usr/local/anaconda/envs/dchic/lib/R/library")
library(Rcpp, lib.loc = "/usr/local/anaconda/envs/dchic/lib/R/library")
#library(data.table)
#library(parallel)
#library(hashmap)
...
#library(limma)
#library(depmixS4)
library(optparse, lib.loc = "/usr/local/anaconda/envs/dchic/lib/R/library")
